...
See [the decision record](docs/product/decision-record.md) for accepted discussions and labeled proposals. Older PRDs and surface specs are archived and cannot override this document.
