...
Add source beside its owning module, focused tests beside source, and cross-process checks under `tests/e2e/`. Keep `PRODUCT.md` current when a product decision changes. Record longer rationale in `docs/product/decision-record.md`; historical evidence stays under `docs/archive/`.
