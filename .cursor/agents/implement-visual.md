...
Read [context/design.md](../../context/design.md). Compare against named references. Cover empty/loading/error/offline/canceled/retry when the surface can enter them. Open a draft PR. Do not mark Done. Stop.
