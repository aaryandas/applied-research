...
| Linear MCP                                                | Can read the Applied Research project graph                   | Draft receipts; no dispatch of AR tickets                                                 |
| GitHub                                                    | `gh` can read this repo, PRs, checks                          | Park landing; harness docs can still land via this agent’s git                            |
| Computer-use / browser                                    | Available when visual tickets are Ready                       | Park visual tickets; continue non-visual                                                  |
