...
- Current authority is rechecked before each upsert/query attempt and after query completion. Duplicate rows within one branch do not inflate fusion scores.
