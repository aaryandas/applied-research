...
| Retained explanation Canvas **DTO** (not persisted/mounted)                                                                                                                                                                                                                                                                 | AR-49 / AR-56       | [ar56-shared-desktop.patch.md](./ar56-shared-desktop.patch.md) §9          |
...
AR-54 clip player remains unmounted. Main reserves attempt identity then calls `requestClip({ explanationId, attemptId, origin, plan, signal })` and currently returns the honest unavailable state.
