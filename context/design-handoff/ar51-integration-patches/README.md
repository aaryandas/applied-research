...
| `HttpDependencies`, `POST /v1/learning/explanation-plans`, runtime provider/service, **typed `PublicPaidResponse`**, same `generation-eval` $2/10 ledger, `workspace-plain-v1` | AR-48               | [ar48-planner-registration.patch.md](./ar48-planner-registration.patch.md) |
| Retained explanation Canvas projection (`projectRetainedExplanationToCanvas`) + placement identity                                                                             | AR-49 / AR-56       | [ar56-shared-desktop.patch.md](./ar56-shared-desktop.patch.md) §9          |
