...
| `context/factory.md`           | Cursor factory graph, memory rules, and harness contract                   |
| `factory/`                     | BOARD, envelopes, contracts, evidence, automation recipes                  |
| `.cursor/rules/`               | Path-scoped agent rules (Electron, renderer, gauntlet loop)                |
| `.cursor/agents/`              | Custom subagents: implement-sol, implement-visual, critic-fable, integrate |
| `.cursor/skills/gauntlet-*/`   | Coordinator / implement / critic / integrate playbooks                     |
| `.cursor/BUGBOT.md`            | Bugbot-only review gates (not loaded as agent rules)                       |
