...
The original Applied Research system had a strong intellectual premise: the source, the machine, and the human should have different visual voices. Its weakness was the distance between that premise and a dependable working experience. The canvases were attractive arrangements of states, but counts drifted, verification language overreached, completion threatened unfinished writing, and too much meaning depended on subtle material differences. The full evidence remains in the original teardown in the [Obsidian Designs Index](../knowledge-base.md).
